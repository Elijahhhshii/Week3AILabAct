...
print("Total students approved for the fast lane:", fast_lane_count)

print("\nQuestion 4:")
print("Ella is approved for the fast lane because she has a teacher's pass.")
print("A teacher's pass overrides the normal rules for minutes left and number of items.")
